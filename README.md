...
Este projeto apresenta uma arquitetura data lakehouse end-to-end no GCP, integrando Cloud Storage e BigQuery, para o setor bancário. O projeto foi desenvolvido como um estudo de caso prático para modernizar a plataforma de dados do Banco XYZ, uma instituição financeira fictícia, visando escalabilidade e inteligência de negócio.
